...
const InputSection = ({ result, setResult }) => {
    ...
    return (
        ...
        <div className={result ? 'flex w-full' : 'min-h-screen flex flex-col w-full justify-center items-center'}>
            ...
            <div className={result ? `fixed bottom-4 flex flex-col md:flex-row justify-center items-center gap-4 w-full max-w-4xl left-1/2 -translate-x-1/2 bg-zinc-100 px-4 py-2 rounded-2xl` : `bg-zinc-100 rounded-2xl flex flex-col md:flex-row gap-5 w-full max-w-4xl px-4 py-2  items-center`}>
